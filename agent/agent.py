...
class Agent(nn.Module):
    ...
    def sync_from(self, net: nn.Module):
        ...
        # self.base_conv_net.load_state_dict(net.base_conv_net.state_dict())
        # self.base_lstm_net.load_state_dict(net.base_lstm_net.state_dict())
        # self.base_value_net.load_state_dict(net.base_value_net.state_dict())
        # self.base_policy_net.load_state_dict(net.base_policy_net.state_dict())
        # if self._use_pixel_change:
    ...
    def sync_to(self, net: nn.Module):
        ...
        #     gp._grad = lp.grad
        # for lp, gp in zip(self.base_policy_net.parameters(), net.base_policy_net.parameters()):
        #     gp._grad = lp.grad
        # if self._use_pixel_change:
    ...
    #         'base_policy_state_dict': self.base_policy_net.state_dict(),
    #     }
    #     if self._use_pixel_change:
    ...
    #     self.base_policy_net.load_state_dict(checkpoint['base_policy_state_dict'])
    #     if self._use_pixel_change:
    ...
    # def eval(self):
    #     self.base_conv_net.eval()
    #     self.base_lstm_net.eval()
    #     self.base_value_net.eval()
    ...
    # def train(self):
    #     self.base_conv_net.train()
    #     self.base_lstm_net.train()
    #     self.base_value_net.train()
    #     self.base_policy_net.train()
    #     if self._use_pixel_change:
    #         self.pc_net.train()
    #     if self._use_reward_prediction:
    #         self.rp_net.train()
